...
5. O modificar el **Project Url** para incluir tu IP: `https://127.0.0.1:44384`
...
- Verifica que la IP 127.0.0.1 sea la correcta:
```powershell
ipconfig
```
...
3. Prueba desde un navegador en otra PC de la red: `https://127.0.0.1:44384/api/conversion/info`
