...
- Ejemplo:
  - Computadora: `127.0.0.1`
  - Celular: `127.0.0.1` ✅ (mismo rango)
  - Celular: `127.0.0.1` ❌ (diferente red)
...
**Reemplaza `127.0.0.1` con tu IP real.**
...
**Reemplaza `127.0.0.1` con la IP de tu computadora.**
