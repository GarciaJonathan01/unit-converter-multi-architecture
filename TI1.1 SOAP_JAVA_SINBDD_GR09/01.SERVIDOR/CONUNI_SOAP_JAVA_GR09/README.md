...
```
http://127.0.0.1:8080/conversion/WSConversion?wsdl
```

**Reemplaza `127.0.0.1` con la IP de tu servidor.**
...
**Remoto (ejemplo con IP 127.0.0.1):**
- WSDL: `http://127.0.0.1:8080/conversion/WSConversion?wsdl`
- Endpoint: `http://127.0.0.1:8080/conversion/WSConversion`
