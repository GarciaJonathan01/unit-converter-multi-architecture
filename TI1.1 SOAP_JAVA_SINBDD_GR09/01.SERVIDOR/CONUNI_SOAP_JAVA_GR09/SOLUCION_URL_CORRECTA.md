...
```
http://127.0.0.1:8080/CONUNI_SOAP_JAVA_GR09-1.0-SNAPSHOT/WSConversion?wsdl
```
...
**Reemplaza `127.0.0.1` con la IP que obtuviste en el Paso 1.**
...
```
http://127.0.0.1:8080/WSConversion?wsdl
```
