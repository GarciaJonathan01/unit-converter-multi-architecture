...
**❌ INCORRECTO:**
```
http://127.0.0.1:8080/CONUNI_SOAP_JAVA_GR09/WSConversion?wsdl
```
Esta URL es solo para **ver el WSDL** (descripción), no para **llamar al servicio**.

**✅ CORRECTO - Endpoint del servicio:**
```
http://127.0.0.1:8080/CONUNI_SOAP_JAVA_GR09/WSConversion
```
(Sin `?wsdl` al final)
...
2. URL: `http://127.0.0.1:8080/CONUNI_SOAP_JAVA_GR09/WSConversion?wsdl`
...
```bash
wsimport -keep http://127.0.0.1:8080/CONUNI_SOAP_JAVA_GR09/WSConversion?wsdl
```

### Opción 3: Desde SOAP UI o Postman

1. Crea una nueva petición SOAP
2. Endpoint: `http://127.0.0.1:8080/CONUNI_SOAP_JAVA_GR09/WSConversion`
