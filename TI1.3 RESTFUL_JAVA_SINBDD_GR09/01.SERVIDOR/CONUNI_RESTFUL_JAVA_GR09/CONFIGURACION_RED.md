...
# Anota la "Dirección IPv4" (ejemplo: 127.0.0.1)
```
...
```
http://127.0.0.1:8080/CONUNI_RESTFUL_JAVA_GR09
```
*Cambia `127.0.0.1` por tu IP real*
...
fetch('http://127.0.0.1:8080/CONUNI_RESTFUL_JAVA_GR09/api/conversion/temperatura/celsius-to-fahrenheit?celsius=100')
...
```java
// Android - Java
String url = "http://127.0.0.1:8080/CONUNI_RESTFUL_JAVA_GR09/api/conversion/temperatura/celsius-to-fahrenheit?celsius=100";
// Usar OkHttp, Retrofit, etc.
```

```swift
// iOS - Swift
let url = URL(string: "http://127.0.0.1:8080/CONUNI_RESTFUL_JAVA_GR09/api/conversion/temperatura/celsius-to-fahrenheit?celsius=100")!
...
public class ConversionService {
    private static final String BASE_URL = "http://127.0.0.1:8080/CONUNI_RESTFUL_JAVA_GR09/api/conversion";
...
class MonsterConverter {
    constructor(baseUrl) {
        this.baseUrl = baseUrl || 'http://127.0.0.1:8080/CONUNI_RESTFUL_JAVA_GR09/api/conversion';
    }
...
# Probar el servicio
curl http://127.0.0.1:8080/CONUNI_RESTFUL_JAVA_GR09/api/conversion/info
```

### **2. Desde móvil (misma red WiFi):**
- Abrir navegador
- Ir a: `http://127.0.0.1:8080/CONUNI_RESTFUL_JAVA_GR09/api/conversion/info`
